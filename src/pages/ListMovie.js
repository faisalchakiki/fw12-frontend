...
const ListMovie = () => {
  ...
  return (
    <div>
      ...
      <main className="bg-[#5C5C5C] h-auto pt-[40px] flex flex-col">
        <div className="px-[50px] lg:px-[120px] flex-col md:flex-row flex justify-between items-center">
          <h3 className="text-[32px]">List Movie</h3>
          <div className="flex">
        ...
        <Month />
        <div className="bg-[#1d212f] py-[30px] px-[2%] sm:px-[2%] lg:px-[4%] rounded-[5px] mt-5 mx-[50px] lg:mx-[120px]  justify-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {movie?.map((data) => (
            <div className="bg-[#5C5C5C] p-5 rounded-[5px] w-[100%] text-center">
              ...
              <div className="title text-white text-[13px] sm:text-[22px] font-semibold mt-[10px]">
                {data.title}
              </div>
              <div className="genre text-[12px] sm:text-[16px] md:mb-[25px]">
                {data.genre}
              </div>
              <BtnDetails
                path="/details"
          ...
          {totalPage.map((res) => {
            if (res === page) {
              ...
              return (
                <div
                  onClick={() => setPage(res)}
                  className="w-[30px] h-[30px]  flex items-center justify-center rounded hover:bg-[#fca311] hover:text-white border border-[#dedede] font-semibold cursor-pointer mx-1"
                >
                  {res}
                </div>
              );
