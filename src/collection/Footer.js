        ...
        <div className="top lg:flex justify-between">
          ...
          <div className='mb-4'>
            ...
            <div>
              <Link
                to="/homepage"
                className="text-[#6e7191] text-[17px] font-semibold hover:text-[#5f2eea]"
              >
                Home
              </Link>
            </div>
            <div>
              <Link
                to="/listMovie"
                className="text-[CC] text-[17px] font-semibold hover:text-[#5f2eea]"
              >
                List Movie
              </Link>
            </div>
          ...
          <div className='mb-4'>
            ...
            <div className="flex justify-start items-center">
              ...
              <p className="ml-2 text-[#6e7191] text-[16px] font-semibold">Tickitz Cinema id</p>
            </div>
            <div className="flex justify-start items-center">
              <img className="w-[25px] h-[25px]" src={Instagram} alt="instagram"/>
              <p className="ml-2 text-[#6e7191] text-[16px] font-semibold">tickitz.id</p>
            </div>
            <div className="flex justify-start items-center">
